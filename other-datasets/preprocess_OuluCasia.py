...
import numpy as np
import random
from config import OuluCasia_path,training_ratio

anger_path = os.path.join(OuluCasia_path, 'anger')
disgust_path = os.path.join(OuluCasia_path, 'disgust')
fear_path = os.path.join(OuluCasia_path, 'fear')
happy_path = os.path.join(OuluCasia_path, 'happiness')
sadness_path = os.path.join(OuluCasia_path, 'sadness')
surprise_path = os.path.join(OuluCasia_path, 'surprise')
neutral_path = os.path.join(OuluCasia_path, 'neutral')



foldspath = os.path.join(OuluCasia_path,'Folds')
